...
public class Graph {
	...
	public int getIndex(String name) {
		for (int i = 0; i < vertexMap.size(); i++) {
			if (vertexMap.get(i).getName().equals(name)) {
				return i;
			}
		}
	...
	public void addVertex(Vertex vertex) {
		if (vertexMap.containsKey(vertex.getName())) {
			throw new IllegalArgumentException("Vertex " + vertex.getName() + " already exists in the graph");
		} else
	...
	public void dijkstra(String startName) {
		...
		while (!pq.isEmpty() && nodesSeen < vertexMap.size()) {
			...
			// Number of priority queue operations, thus priority queue processing
	...
	public String getSummary() {
		// returns number of vertices, edges, pq operations processed
		return vCount + "," + eCount + "," + pqCount;
	}
